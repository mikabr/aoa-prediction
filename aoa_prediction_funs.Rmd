...
```{r}
english_predictors <- c("frequency", "resid_kl", "mlu", "concreteness", "num_characters",
...
ggplot(english_data, aes(x = num_characters)) +
  geom_density()

ggplot(english_data, aes(x = num_characters, y = aoa)) +
  geom_text(aes(label = uni_lemma))
