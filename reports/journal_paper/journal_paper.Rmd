...
We use CDI data from Wordbank to estimate the acquisition trajectories for words across `r num_langs` languages: `r paste(unique(lang_coefs$language), collapse = ", ")`. We then ask what factors are most important for predicting this trajectory. Table \ref{table:lang_stats} gives an overview of our data sources [TODO: port this table].
