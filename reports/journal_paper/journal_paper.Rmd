---
title: "Predicting word learning across languages"
...
lang_coefs <- lang_coefs %>%
  ...
  mutate(measure = fct_recode(measure, 
                               ...
                               "Produces" = "produces"),
         interaction = fct_recode(interaction, 
                                   "Main effect" = "main effect", 
                                   "Interaction with age" = "interaction with age"))
...
empirical_lang_summary <- empirical_lang_summary %>%
  ungroup %>%
  mutate(measure = fct_recode(measure, 
                               "Understands" = "understands", 
                               "Produces" = "produces"),
...
ggplot(NULL, aes(x = dummy, y = mean_cor)) +
  ...
  geom_rect(aes(ymin = ci_lower_cor, ymax = ci_upper_cor, xmin = 0.5, xmax = 1.5),
                  data = baseline_summary, colour = "lightgray", alpha = .1, linetype = 0) +
...
plt_lexcat_coefs <- lexcat_coefs %>%
  ...
  mutate(measure = fct_recode(measure, "Understands" = "understands", 
                              "Produces" = "produces"), 
         lexical_category = fct_recode(lexical_category, "Function words" = "Function Words"))
