...
opts_chunk$set(fig.path = "figures_si/")
```
...
```{r by-lang-age, fig.pos='bh!', fig.height=10, fig.width=10, out.width="0.9\\fullpagewidth", fig.cap="Age interactions for each language and measure with 95\\% confidence intervals."}
