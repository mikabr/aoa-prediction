...
As another illustration of the structure of our dataset, we show the centered and scaled distribution of the values of each predictor in each language.

```{r predictor-dist, fig.pos='bh', fig.width=8, fig.height=8, out.width="85%", fig.cap="Densities of the values of each predictor for each language."}
