...
As a supplement to Figure \ref{fig:langcoefs}, we show the coefficient estimates separately for each language, first for the main effects and then for the age interactions.
...
by_lang_plot <- function(meas, int) {
  ggplot(filter(plt_lang_coefs, measure == meas, interaction == int),
...
plot_grid(by_lang_plot("understands", "interaction with age"),
          ...
          ncol = 1, label_size = 14, hjust = 0,
          labels = c("Age interactions – Understands", "Age interactions – Produces"))
```
