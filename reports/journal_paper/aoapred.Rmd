...
The primary tool for characterizing the breadth of children's early vocabulary in these previous studies is structured parent report. While naturalistic language samples and experimental methods both can be valuable methods, outside of a few examples [e.g., @roy2015], neither method provides the kind of holistic view that comes from 
...
aggregates administrations of the CDI across languages. Wordbank archives
