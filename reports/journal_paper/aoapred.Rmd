...
```{r lexcatcoefs, fig.width=7, fig.height=3.5, fig.align='center', fig.cap="Estimates of coefficients in predicting words' developmental trajectories (as described in Figure \ref{fig:langcoefs}), with separate models for each lexical category."}
