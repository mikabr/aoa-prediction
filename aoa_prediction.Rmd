---
title: <center>Predicting Age of Acquisition for Early Words Across Languages</center>
...
joined_predictor_means %>%
  ...
  geom_dl(aes(label = predictor),
          method = list("first.qp", dl.trans(x = x - 0.3), cex = 0.6, fontfamily = font)) +
  geom_dl(aes(label = predictor),
          method = list("last.qp", dl.trans(x = x + 0.3), cex = 0.6, fontfamily = font)) +
  scale_colour_solarized(guide = FALSE) +
  xlab("\nAge of Acquisition (months)") +
  ylab("Mean Predictor Z-Score\n") +
  theme(text = element_text(family = font),
...
joined_predictor_means %>%
  ...
  geom_line(aes(group = predictor)) +
  geom_dl(aes(label = predictor),
          method = list("first.qp", dl.trans(x = x - 0.2), cex = 0.6, fontfamily = font)) +
  geom_dl(aes(label = predictor),
          method = list("last.qp", dl.trans(x = x + 0.2), cex = 0.6, fontfamily = font)) +
  scale_colour_solarized(guide = FALSE) +
  xlab("\nAge of Acquisition (months)") +
  ylab("Mean Predictor Z-Score\n") +
  theme(text = element_text(family = font),
